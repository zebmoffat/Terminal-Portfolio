function About() {
  const about = `
    ...
    I'm a software engineering junior at Arizona State University. I was first introduced to coding in high school
    ...
    junior and haven't looked back!
    ...
    I am most proficient with Java, C, JavaScript (especially React), HTML, and CSS.
